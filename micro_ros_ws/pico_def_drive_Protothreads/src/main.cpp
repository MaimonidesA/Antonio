...
void  setupOdomMsg(){
    ...
    //TWIST
	OdomMsg.twist.twist.linear.x = 3.0;
	OdomMsg.twist.twist.linear.y = 3.0;
	OdomMsg.twist.twist.linear.z = 3.0;
	OdomMsg.twist.twist.angular.x = 3.0;
	OdomMsg.twist.twist.angular.y = 3.0;
	OdomMsg.twist.twist.angular.z = 3.0;
